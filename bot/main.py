...
from database import init_db, fetch_all, create_user
from ai_parser import parse_food_image, parse_food_text
...
CUISINE_FLAGS = {
    ...
    "Марокканская": "🇲🇦", "Вьетнамская": "🇻🇳", "Другая": "🌍",
}
...
async def get_cuisines():
    """Возвращает кухни, которые реально есть в базе, с флагами"""
